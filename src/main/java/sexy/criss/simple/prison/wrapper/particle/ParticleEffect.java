package sexy.criss.simple.prison.wrapper.particle;
...
public enum ParticleEffect {
	...
	private static boolean isLongDistance(Location location, List<Player> players) {
		...
		for (Player player : players) {
			...
			if (!world.equals(playerLocation.getWorld().getName()) || playerLocation.distanceSquared(location) < 65536) continue;
	...
	public enum ParticleProperty {
		REQUIRES_WATER, REQUIRES_DATA,
		DIRECTIONAL, COLORABLE
	}
